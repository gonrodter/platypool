    ...
    <PageChrome>
      <section className="px-5 py-16 sm:px-8 sm:py-24">
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            <Words as="h1" className="display text-[clamp(2.6rem,6vw,4.8rem)]" text={es ? "Cambia la red. / No tu *Platypool*" : "Le filet change. / Pas votre *Platypool*"} />
      ...
      <section className="expand bg-stone px-5 py-20 sm:px-8 sm:py-28" data-expand>
        <div className="mx-auto max-w-4xl text-center">
          <Words className="display text-[clamp(2rem,5vw,3.8rem)]" text={es ? "Una pieza de desgaste. / Muchos años *más*" : "Une pièce d'usure. / Des années de *plus*"} />
        </div>
      </section>
    </PageChrome>
  );
